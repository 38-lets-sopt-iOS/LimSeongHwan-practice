...
final class SignupService {
    ...
    private func makeRequestBody(loginId: String, password: String, name: String, email: String, age: Int, part: String) -> Data? {
        do {
            let data = SignupRequestDTO(loginId: loginId, password: password, name: name, email: email, age: age, part: part)
    ...
    func postSignup(loginId: String, password: String, name: String, email: String, age: Int, part: String) async throws -> SignupResponseDTO {
        guard let body = makeRequestBody(loginId: loginId, password: password, name: name, email: email, age: age, part: part) else {
